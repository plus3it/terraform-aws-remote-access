...
parser.add_argument(
    "--url", dest="url", required=True, action="store", help="URL to query"
)
parser.add_argument(
    "--searchstring",
    dest="searchstring",
...
def test_page_content():
    assert (
        search_page_content() == f"The phrase '{searchstring}' has been found!"
    ), f"The phrase '{searchstring}' wasn't found"
